...
const Profile = ({ userData }) => {
    ...
    return (
        <div className='bg-transparent border border-gray-500 rounded-xl lg:flex flex-row  justify-between px-10 py-5'>
            ...
            <div className=" flex flex-col justify-center gap-10 items-center bg-transparent w-full " >
                <div className='text-center text-white mt-6 text-xl lg:w-full lg:text-[2rem]'>
