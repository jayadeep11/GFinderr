...
const Profile = ({ userData }) => {
    ...
    return (
        <div className='bg-transparent border rounded-xl px-10 py-5'>
            ...
            <div className="bio flex flex-col bg-gray-300 items-center justify-center gap-2  w-full  lg:w-1/2" >
                ...
                <Link to='/userdetails' className='border border-gray-500 rounded-xl'>View profile</Link>
            </div>
